...
Step ageStep(int currentStep, int age, Function setState, BuildContext context, Function(String) onChanged) {
  return Step(
...
Step genderStep(int currentStep, int selectedGender, Function setState, String genre, Function(int?) onChangedMale, Function(int?) onChangedFemale) {
  return Step(
...
Step symptomStep(int currentStep, Function setState, List<String> symptoms, BuildContext context, Function(List<String>) onConfirm) {
